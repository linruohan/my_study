...
#163邮箱发
from_addr='mjt122000@163.com'
to_addr='mjt1220@126.com'
smtp_server='smtp.163.com'
passwd='Mm1214875764'    #授权码
...
msg['Subject']=Header('来自smtp的问候...小寒测试邮件..','utf-8').encode()

# server=smtplib.SMTP(smtp_server,25)#126
server=smtplib.SMTP(smtp_server,25)#163
