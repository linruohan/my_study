...
class HBaseTester:
    ...
    def __init__(self, netloc, port, table="vehicle_sdn_list"):
    ...
    def scanner(self, column):
        scanner = self.client.scannerOpen(self.tablename, "", [column])
...
class TestHBaseTester(TestCase):
    ...
    def setUp(self):
        self.writer = HBaseTester("193.169.100.33", 2181)
...
if __name__ == "__main__":
    s=HBaseTester("193.169.100.33", 2181,)