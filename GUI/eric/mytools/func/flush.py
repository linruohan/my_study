...
class Example(QWidget):
    ...
    def initUI(self):
        ...
        self.lcd.setStyleSheet("border: 12px solid green; color: white; background: black;")  # 设置显示的颜色样式
        vbox = QVBoxLayout()  # 设置布局
        vbox.addWidget(self.lcd)
        self.setLayout(vbox)
        self.setGeometry(300, 300, 250, 150)
        self.setWindowTitle('hello')
        dir_path = os.path.abspath(os.path.dirname(__file__)) + './img/little_sanke.ico'
