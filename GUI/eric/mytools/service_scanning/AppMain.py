...
4. 任务栏图标显示
"""
import os.path,webbrowser,wx,sys,win32service,logging
from logging.handlers import RotatingFileHandler
import AppResource
from AppXml import *
import wx.adv

from AppXml import XmlNode
...
C_APP_SITE = "http://127.0.0.1/?app=service_moniter&version=1.0.0"
...
class ServiceControl(object):
    ...
    def start(self,name):
        try:
            handle = win32service.OpenService(self.scm,name,win32service.SERVICE_ALL_ACCESS)
            if handle:
