...
class MyCapture:
    ...
    def onLeftButtonUp(self,event):
        ...
        ##弹出保存截图对话框
        #
        #fileName=tkinter.filedialog.asksaveasfilename(title='保存截图',filetypes=[('JPGfiles','*.jpg')])
        #
        #iffileName:
        #
...
w.buttonCapture.wait_window(w.top)
...
label.config(text='Newtest')
buttonCapture=tkinter.Button(root,text='截图',command=w.buttonCaptureClick)
